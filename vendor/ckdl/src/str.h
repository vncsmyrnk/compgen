...
KDL_NODISCARD kdl_owned_string kdl_escape_v1(kdl_str const *s,
...
KDL_NODISCARD kdl_owned_string kdl_escape_v2(kdl_str const *s,
                                             kdl_escape_mode mode);
// Resolve backslash escape sequences according to KDLv2 rules for single-line
// strings
KDL_NODISCARD kdl_owned_string kdl_unescape_v2_single_line(kdl_str const *s);
// Resolve backslash escape sequences according to KDLv2 rules for multi-line
// strings
